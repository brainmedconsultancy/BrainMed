...
Trusted support for global admissions
          ...
          >
            Global Bridge helps students choose the right country, shortlist
            colleges, manage applications, and navigate visas with clarity from
            day one.
          </motion.p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-[1.5rem] bg-brand-600 p-5 text-white">
                  ...
                  <p className="mt-2 text-sm leading-6 text-brand-50">
                    Your team can review form submissions quickly from the admin
                    dashboard and act without delay.
                  </p>
                </div>
              </div>
            </div>
