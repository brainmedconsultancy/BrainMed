export const stats = [
  { value: "12+", label: "Years guiding students worldwide" },
  { value: "3.5K+", label: "Successful application journeys" },
  { value: "95%", label: "Visa success support rate" },
  { value: "80+", label: "Partner colleges and universities" },
];
...
export const services = [
  {
    ...
    description:
      "Personalized counseling that maps your academic goals, budget, and profile to the right destination.",
  },
  {
    title: "Visa Assistance",
    description:
      "End-to-end support for documentation, interview preparation, and checklist management.",
  },
  {
    title: "College Selection",
    description:
      "Balanced shortlisting based on ranking, affordability, scholarships, and career outcomes.",
  },
  {
    title: "Application Processing",
    description:
      "Statement review, portal submissions, deadlines tracking, and offer follow-up handled in one place.",
  },
  {
    title: "Career Counseling",
    description:
      "Course and career planning sessions to connect your education choice with long-term opportunities.",
  },
];
